...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    It is used to get the URL or the Path of the route you are going to. URL is the literal url after the base url in the browser, path is the path you specified in the route.

2. How would you explain form validation to someone who has never programmed before?
    making sure the inputs in the form are valid. Emails are emails, names dont conatin numbers, age is a number, a
    checkbox is checked, etc....

3. In 1-2 sentences, define end to end testing. 
    End to end testing is tesing functionality of your application, if inputs can be inputted to and the values are as expected.
